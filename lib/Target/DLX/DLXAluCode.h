//===-- DLXAluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_DLX_DLXALUCODE_H
#define LLVM_LIB_TARGET_DLX_DLXALUCODE_H
...
const int DLX_PRE_OP = 0x40;
const int DLX_POST_OP = 0x80;

inline static unsigned encodeDLXAluCode(unsigned AluOp) {
...
inline static const char *DLXAluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToDLXAluCode(StringRef S) {
...
inline static AluCode isdToDLXAluCode(ISD::NodeType Node_type) {
  switch (Node_type) {
  case ISD::ADD:
    return AluCode::ADD;
  case ISD::ADDE:
...
#endif // LLVM_LIB_TARGET_DLX_DLXALUCODE_H
