...
#ifndef LLVM_LIB_TARGET_DLX_DLXCONDCODE_H
#define LLVM_LIB_TARGET_DLX_DLXCONDCODE_H
...
inline static StringRef DLXCondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToDLXCondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_DLX_DLXCONDCODE_H
